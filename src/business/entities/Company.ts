...
import { CompanyProps, Adress } from "../types/Company";
...
export class Company {
    ...
    public constructor(props: CompanyProps) {
        ...
        this.employees = props.employees.map((emp) => 
            emp instanceof Types.ObjectId ? emp.toString() : emp
        );
    ...
    public async create(props: CompanyProps) : Promise<Company> {
        return new Company(props);
    }

    public toJson(): CompanyProps {
        return {
            id: this.id,
            email: this.email,
            name: this.name,
